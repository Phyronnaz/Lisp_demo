 ...
 * No provision is made to escape quotes in strings.
*)

(* The double  [^ '"' '"' ] is just a trick to have an even number
 * of quotes within the line, so that the Atom highlighting system is happy.
 * Please, indulge it.
 *)
let STRING = '"' [^ '"' '"' ]* '"'
